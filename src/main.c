...
{
	0,0,4368,4368,4368,4368,0,0,0,4368,4368,4368,4368,4368,4368,0,4368,4368,4368,40224,40224,4368,4368,4368,4368,4368,40224,40224,40224,40224,4368,4368,4368,4368,40224,40224,40224,40224,4368,4368,4368,4368,4368,40224,40224,4368,4368,4368,0,4368,4368,4368,4368,4368,4368,0,0,0,4368,4368,4368,4368,0,0,
};
...
int main()
{
	...
	int direction[] = {0, 1, 1}; // fish_direction
	int obsDir[] = {0, 1, 0};    // obstacle_direction
	...
	// Sound Effects
	uint32_t notesCatch[] = {C6, E6, G6};
	uint32_t dursCatch[] = {100, 100, 100};
	uint32_t notesDamage[] = {FS5_Gb5, F5, DS5_Eb5};
	uint32_t dursDamage[] = {100, 100, 100};
	uint32_t notesOver[] = {A3, F3, D3}; 
	uint32_t dursOver[] = {500, 250, 500}; 
